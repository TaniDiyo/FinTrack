...
const API_BASE = "http://13.61.173.220:5000/api"
          ...
          <div className={styles.grid.rightColumn}>
            <div className={styles.cards.base}>
              <div className={styles.transactions.cardHeader}>
                ...
                >
                  <RefreshCw
                    className={`${styles.transactions.refreshIcon} ${loading ? "animate-spin" : ""
                      }`}
                  />
                </button>
              </div>
                ...
                {topCategories.map(([category, amount]) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span
                        className={styles.categories.categoryName}
                      >
                        {category}
                      </span>
                    </div>
                    ...
                    <span
                      className={styles.categories.categoryAmount}
                    >
                      ₹{amount}
                    </span>
                  </div>
